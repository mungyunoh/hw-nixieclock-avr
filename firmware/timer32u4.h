...
#define TIMER3OVERFLOW_INT			8
#define TIMER3OUTCOMPAREA_INT		9
#define TIMER3OUTCOMPAREB_INT		10
#define TIMER3OUTCOMPAREC_INT 		11
#define TIMER3INPUTCAPTURE_INT		12
#define TIMER4OVERFLOW_INT			13
#define TIMER4OUTCOMPAREA_INT		14
#define TIMER4OUTCOMPAREB_INT		15
#define TIMER4OUTCOMPARED_INT		16
#define TIMER4FAULTPROTECT_INT		17
#define TIMER_NUM_INTERRUPTS		18


// default type of interrupt handler to use for timers
// *do not change unless you know what you're doing
// Value may be SIGNAL or INTERRUPT or ISR
...
#define TIMER_MODE_PWM_PHASECORRECT_8BIT 					0b00000001
#define TIMER_MODE_PWM_PHASECORRECT_9BIT 					0b00000010
#define TIMER_MODE_PWM_PHASECORRECT_10BIT 					0b00000011
#define TIMER_MODE_CTC_OCR 									0b00001000
#define TIMER_MODE_FASTPWM_8BIT 							0b00001001
#define TIMER_MODE_FASTPWM_9BIT 							0b00001010
#define TIMER_MODE_FASTPWM_10BIT 							0b00001011
#define TIMER_MODE_PWM_PHASECORRECT_FREQUENCYCORRECT_ICR 	0b00010000
#define TIMER_MODE_PWM_PHASECORRECT_FREQUENCYCORRECT_OCR 	0b00010001
#define TIMER_MODE_PWM_PHASECORRECT_ICR 					0b00010010
#define TIMER_MODE_PWM_PHASECORRECT_OCR 					0b00010011
#define TIMER_MODE_CTC_ICR 									0b00011000
#define TIMER_MODE_FASTPWM_ICR 								0b00011010
#define TIMER_MODE_FASTPWM_OCR 								0b00011011
#define TIMER_MODE_TCCRNA_MASK								0b00000011
#define TIMER_MODE_TCCRNB_MASK								0b00011000

// timer output modes
#define TIMER_OUTMODE_DISCONNECTED	0
#define TIMER_OUTMODE_TOGGLE		1
#define TIMER_OUTMODE_CLEAR			2
#define TIMER_OUTMODE_SET 			3
...
void timer3SetPrescaler(uint8_t prescale);		///< set timer3 prescaler
uint16_t  timer3GetPrescaler(void);				///< get timer3 prescaler
void timer4SetPrescaler(uint8_t prescale);		///< set timer4 prescaler
uint16_t  timer4GetPrescaler(void);				///< get timer4 prescaler
...
uint32_t timer0GetOverflowCount(void);		///< read timer0's overflow counter
void timer1ClearOverflowCount(void);	///< clear timer1's overflow counter
uint32_t timer1GetOverflowCount(void);		///< read timer1's overflow counter
void timer3ClearOverflowCount(void);	///< clear timer3's overflow counter
uint32_t timer3GetOverflowCount(void);		///< read timer3's overflow counter
void timer4ClearOverflowCount(void);	///< clear timer4's overflow counter
uint32_t timer4GetOverflowCount(void);		///< read timer4's overflow counter
