...
// strings
const uint8_t PROGMEM CmdlinePrompt[] = "cmd>";
const uint8_t PROGMEM CmdlineNotice[] = "cmdline: ";
const uint8_t PROGMEM CmdlineCmdNotFound[] = "command not found";
...
void cmdlineProcessInputString(void)
{
	...
	{
		if( !strncmp((char *)CmdlineCommandList[cmdIndex], (char *)CmdlineBuffer, i) )
		{
