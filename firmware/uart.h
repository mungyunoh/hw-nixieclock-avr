...
#define UBRRL				UBRR0L
#define UBRRH				UBRR0H
#define UART_TRANS_vect		USART_TRANS_vect
#define UART_RECV_vect		USART_RECV_vect
#define SIG_UART_DATA_vect	SIG_USART_DATA_vect
#endif
...
#define UBRRL 				UBRR1L
#define UBRRH 				UBRR1H
#define UART_TRANS_vect 	USART1_TX_vect
#define UART_RECV_vect 		USART1_RX_vect
#define UART_DATA_vect 		USART1_UDRE_vect
#endif
// compatibility with mega169 processors
#if	defined(__AVR_ATmega169__)
#define UART_TRANS_vect		USART_TRANS_vect
#define UART_RECV_vect		USART_RECV_vect
#define UART_DATA_vect		USART_DATA_vect
#endif
...
#define UCR					UCSR0B
#define UBRRL				UBRR0
#define UART_TRANS_vect		UART0_TRANS_vect
#define UART_RECV_vect		UART0_RECV_vect
#define UART_DATA_vect		UART0_DATA_vect
#endif
...
#define UBRRL				UBRR1L
#define UBRRH				UBRR1H
#define UART_TRANS_vect		UART1_TRANS_vect
#define UART_RECV_vect		UART1_RECV_vect
#define UART_DATA_vect		UART1_DATA_vect
#else
#define UDR					UDR0
#define UCR					UCSR0B
#define UBRRL				UBRR0L
